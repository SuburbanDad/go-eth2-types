module github.com/suburbandad/go-eth2-types/v2
...
replace github.com/herumi/bls-eth-go-binary => github.com/SuburbanDad/bls-eth-go-binary v0.0.0-20200619071004-f8df4fcea646
